...
class Reading_rooms(): #Класс "Читательные залы" с переменными: название читательного зала, 
    ...
    def books(self): #  Вывод информации о количестве всех книгах из определенной библиотеки
        ...
        return (f"Вы находитесь в библиотеке с названием <<{self.lib}>>. Сумvарное количество книг во всех библиотеках города равно {x}")
...
b5 = Libraries("Ленин", "Колотушкина 1", "Мухово")

b2 = Book(b2.nameRr, b2.lib, b2.am_books, b2.am_place, b2.wk_time, b2.floor, b2.am_worker, 1054)
b2.Symbols()
b2.books()
#Методы проекта
print(b1.Name())
